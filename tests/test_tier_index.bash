...
test_known_tier_index()
{
    ...
    rbh_ifind "rbh:mongo:$testdb" -tier-index 0 | sort |
        difflines "$obj1" "$obj2"
    rbh_ifind "rbh:mongo:$testdb" -tier-index 1 | sort |
        difflines "$obj2" "$obj3"
    rbh_ifind "rbh:mongo:$testdb" -tier-index 0 -tier-index 1 | sort |
        difflines "$obj2"
    rbh_ifind "rbh:mongo:$testdb" -tier-index 0 -or -tier-index 1 | sort |
...
declare -a tests=(test_syntax_error test_unknown_tier_index
                  test_known_tier_index)
